...
- 2-3 minimal stick figures (round head circle + single-stroke thin limbs, no fill) doing small playful actions that make physical sense relative to THIS specific object's actual visible shape and edges — e.g. climbing up its side on a tiny ladder, watering it, pushing a wheelbarrow toward its base, dangling a fishing line onto it, standing on top of it, fanning it. Anchor at least one figure's hands/feet so they visually touch the object's silhouette edge, not just floating nearby.
